...
| `test_075_component_state_storage.py` | Private fresh queued state, atomic registration, preserved results and producing shape, approved lineage, damaged-row refusal, SQLite constraints, fresh-process schema refusal, and version-4 preservation. Lifecycle transitions and runtime integration remain pending. |
