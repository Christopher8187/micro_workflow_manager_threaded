...
| `test_090_component_session_settlement.py` | Atomic component results and session exit, accepted restart ordering, lineage, stale ownership, unfinished-job refusal, and batch rollback. |
