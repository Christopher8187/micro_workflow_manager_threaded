...
Status: implementation in progress. The [interval calculation](stage-s1a.md) and [command retirement](stage-retirement.md) are accepted; full stages and final review remain pending.
...
| 44-REC-015 | Regression coverage includes interval selection and the S1 read-only preview base. | 44-FCR, `Required reconciliation with current MWF` | 44-CMD-014, 44-CMD-016 through 44-CMD-022, 44-CMD-031 through 44-CMD-036, 44-CMD-038 through 44-CMD-046 | S1 | pending | pending | pending | pending |
...
| 44-REC-044 | Regression coverage includes read-only reporting of stale sessions and the recovery that would occur. | 44-FCR, `Explicit interruption` and `Required reconciliation with current MWF` | 44-INT-051, 44-CMD-039 | S6 | pending | pending | pending | pending |
