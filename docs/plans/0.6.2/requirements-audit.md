...
Status: implementation in progress. The [interval calculation](stage-s1a.md), [command retirement](stage-retirement.md), [shared topology](stage-topology.md), [legacy migration preflight](stage-migration-guard.md), [retained scheduler repair](stage-scheduler-completion.md), [private session storage](stage-session-foundation.md), and [legacy loading preflight and checkpoint renewal](stage-legacy-loading.md) are accepted within their recorded boundaries; full stages and final review remain pending.
...
integration. Independent graph calculations, command removals, and settled
session foundations continue. A blocked integration does not prohibit an
independent new-project calculation whose expected behavior is already settled.
...
| 44-SCP-023 | Subgraph inspection and execution must not execute a component outside the selected execution boundary. | 44-FCR, `Responsibility and scope` | 44-SCP-002, 44-SCP-020 | S1 | pending | pending | pending | pending |
...
| 44-CMP-002 | Every raw node in one component derives one authoritative lifecycle value from the component record. | 44-FCR, `Component model` | 44-CMP-001 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-003 | Component lifecycle values are exactly `queued`, `running`, `sampled`, `done`, and `failed`. | 44-FCR, `Component model` | 44-CMP-002 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-004 | `stable` and `unstable` are successful forms of a done result, not lifecycle values. | 44-FCR, `Component model` | 44-CMP-003 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-005 | A successful unstable result stores one exact interrupt-session ID as its instability origin. | 44-FCR, `Component model` | 44-CMP-004, 44-SES-030 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-006 | Sampled work is not done. | 44-FCR, `Component model` | 44-CMP-003 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-007 | Sampled work retains the compatible stability lineage and origin established by completed work so far. | 44-FCR, `Component model` | 44-CMP-005, 44-CMP-006 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-008 | Queued and failed components have no successful stability result. | 44-FCR, `Component model` | 44-CMP-003, 44-CMP-004 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-009 | A component never automatically carries more than one instability origin. | 44-FCR, `Component model` | 44-CMP-005 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-010 | `misaligned` is a component Boolean separate from lifecycle and stability. | 44-FCR, `Component model` | 44-CMP-002 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
...
| 44-CMP-025 | Persist lifecycle, stability, instability origin, misalignment, and alignment generation once for each exact Hoeflein component. | 44-FCR, `Component model` | 44-CMP-001 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
| 44-CMP-026 | Do not keep independent authoritative copies of component result state on raw-node rows. | 44-FCR, `Component model` | 44-CMP-002, 44-CMP-025 | S2 | pending | pending | pending | legacy result conversion blocked by [AQ2](architectural-questions.md#aq2-converting-legacy-component-results); independent work pending |
...
| 44-CMD-014 | A `from` selection contains the starting component and all its quotient-DAG descendants. | 44-FCR, `The nine graph commands` | published 0.6.1 Hoeflein-component construction | S1 | pending | pending | pending | pending |
...
| 44-CMD-016 | Compute the closed quotient interval as `descendants-or-self(C_A) intersect ancestors-or-self(C_B)` without enumerating paths. | 44-FCR, `The nine graph commands` | published 0.6.1 Hoeflein-component construction | S1 | [calculation](stage-s1a.md) | [checks passed](stage-s1a.md#broader-verification) | [Sol xhigh PASS](selection-review.md#s1a-review-record) | calculation accepted; CLI integration pending |
...
| 44-CMD-025 | Remove `clean`, `cleanfrom`, `wipe`, and `wipefrom` from parser registration. | 44-FCR, `The nine graph commands` | none | S4 | [retirement](stage-retirement.md) | [checks passed](stage-retirement.md#test-first-and-preservation-checks) | [Sol xhigh PASS](retirement-review.md) | accepted |
| 44-CMD-026 | Remove those four commands from command-name collections, `--describe`, help, documentation, generated command examples, and tests. | 44-FCR, `The nine graph commands` | 44-CMD-025 | S6 | [retirement](stage-retirement.md) | [checks passed](stage-retirement.md#test-first-and-preservation-checks) | [Sol xhigh PASS](retirement-review.md) | accepted |
| 44-CMD-027 | Do not leave redirect stubs or a compatibility layer for the four removed commands. | 44-FCR, `The nine graph commands` | 44-CMD-025 | S4 | [retirement](stage-retirement.md) | [checks passed](stage-retirement.md#test-first-and-preservation-checks) | [Sol xhigh PASS](retirement-review.md) | accepted |
| 44-CMD-028 | Example READMEs may receive only the narrow documentation change needed to stop teaching a removed command. | 44-FCR, `The nine graph commands` | 44-CMD-026 | S6 | [retirement](stage-retirement.md) | [checks passed](stage-retirement.md#test-first-and-preservation-checks) | [Sol xhigh PASS](retirement-review.md) | accepted |
| 44-CMD-029 | Do not change example graphs, tasks, or behavior, and do not perform the 0.6.3 example repair. | 44-FCR, `The nine graph commands` | the context-loop decision boundary | ALL | [retirement](stage-retirement.md) | [checks passed](stage-retirement.md#test-first-and-preservation-checks) | [Sol xhigh PASS](retirement-review.md) | verified for retirement; later-stage preservation remains required |
| 44-CMD-030 | Preserve shared fresh-preparation functions used by reset and run. | 44-FCR, `The nine graph commands` | 44-CMD-011 | S3 | [retirement](stage-retirement.md) | [checks passed](stage-retirement.md#test-first-and-preservation-checks) | [Sol xhigh PASS](retirement-review.md) | verified for retirement; later-stage preservation remains required |
| 44-CMD-031 | `runbetween` and `resumebetween` use `--plan` for their read-only previews. | 44-FCR, `The nine graph commands` | 44-CMD-017 | S1 | pending | pending | pending | pending |
| 44-CMD-032 | `resetbetween` uses `--dry-run` for its read-only preview. | 44-FCR, `The nine graph commands` | 44-CMD-017 | S1 | pending | pending | pending | pending |
...
| 44-CMD-039 | Read-only paths cause no durable or externally visible mutation. | 44-FCR, `The nine graph commands` | 44-CMD-038 | S1 | pending | pending | pending | live SQLite preview acceptance blocked by [AQ1](architectural-questions.md#aq1-sqlite-coordination-during-read-only-previews); independent work pending |
...
| 44-CMD-046 | Separate current mutating bootstrap behavior from every advertised read-only path. | 44-FCR, `The nine graph commands` | 44-CMD-040 through 44-CMD-045 | S1 | pending | pending | pending | live SQLite preview acceptance blocked by [AQ1](architectural-questions.md#aq1-sqlite-coordination-during-read-only-previews); independent work pending |
...
| 44-SMP-027 | A read-only plan prints its generated seed without persisting it. | 44-FCR, `Execution sampling` | 44-SMP-025, 44-CMD-039 | S4 | pending | pending | pending | live SQLite preview acceptance blocked by [AQ1](architectural-questions.md#aq1-sqlite-coordination-during-read-only-previews); independent work pending |
...
| 44-INT-051 | A read-only command reports stale sessions and proposed recovery without changing anything. | 44-FCR, `Explicit interruption` | 44-INT-049, 44-CMD-039 | S6 | pending | pending | pending | live SQLite preview acceptance blocked by [AQ1](architectural-questions.md#aq1-sqlite-coordination-during-read-only-previews); independent work pending |
...
| ID | Requirement | Exact source section | Dependencies | Proposed stage | Implementation | Verification | Stage review | Disposition |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 44-SES-001 | Allow at most one live main session. | 44-FCR, `Several execution sessions and ownership` | none | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; persisted running-main cardinality only; runtime admission remains pending |
| 44-SES-002 | Allow several live interrupt sessions. | 44-FCR, `Several execution sessions and ownership` | 44-SES-001 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; multiple persisted interrupt rows only; runtime admission remains pending |
...
| 44-SES-030 | Replace authoritative `.mwf/run.json` state with one SQLite execution-session registry. | 44-FCR, `Several execution sessions and ownership` | published 0.6.1 storage | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; SQLite storage foundation only; supported execution still uses run JSON |
| 44-SES-031 | The registry represents the main session, every interrupt session, actual parent relationships, IDs, commands, starting and selected components, selected jobs, reservations, holds, heartbeats, terminal outcomes, and failures. | 44-FCR, `Several execution sessions and ownership` | 44-SES-030 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; identity, scope, parent, heartbeat, outcomes, and failures persist; reservations, holds, and job ownership remain pending |
| 44-SES-032 | SQLite is the only writable session-state source. | 44-FCR, `Several execution sessions and ownership` | 44-SES-030 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; internal fresh storage writes only SQLite; supported execution still uses run JSON |
| 44-SES-033 | Import safe legacy run information once during migration. | 44-FCR, `Several execution sessions and ownership` | 44-SES-030 | S2 | pending | pending | pending | complete legacy import blocked by [AQ4](architectural-questions.md#aq4-excluding-older-processes-during-migration); independent [private new-project foundation accepted](stage-session-foundation.md); no legacy-import acceptance |
| 44-SES-034 | Never migrate session state underneath a live legacy process. | 44-FCR, `Several execution sessions and ownership` | 44-SES-033 | S2 | [migration preflight](stage-migration-guard.md), [loading and two-record validation](stage-legacy-loading.md#boundary) | [fourteen initial guard cases](stage-migration-guard.md#test-first-record); [loading failures and corrections](stage-legacy-loading.md#test-first-record), [551 ordinary cases, four cycles, independent checks](stage-legacy-loading.md#verification-and-review), and [bounded comparisons](stage-legacy-loading.md#bounded-comparisons) | Initial [safety](migration-safety-review.md) and [compatibility](migration-compatibility-review.md); loading [safety](legacy-loading-safety-review.md) and [compatibility](legacy-loading-compatibility-review.md) PASS | partial; existing incomplete databases remain blocked by [AQ1](architectural-questions.md#aq1-sqlite-coordination-during-read-only-previews), and concurrent older starts by [AQ4](architectural-questions.md#aq4-excluding-older-processes-during-migration); no legacy-import acceptance |
| 44-SES-035 | An API defined to read the main session returns the main session or no result. | 44-FCR, `Several execution sessions and ownership` | 44-SES-030 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; named SQLite main reader only; runtime callers remain pending |
| 44-SES-036 | A legacy generic single-session reader returns a live main session when one exists. | 44-FCR, `Several execution sessions and ownership` | 44-SES-035 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; named SQLite generic reader only; existing generic callers remain on JSON |
| 44-SES-037 | With no main and exactly one live interrupt, the legacy generic reader returns that interrupt. | 44-FCR, `Several execution sessions and ownership` | 44-SES-036 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; named SQLite generic reader only; existing generic callers remain on JSON |
| 44-SES-038 | With no live session, the legacy generic reader returns no result. | 44-FCR, `Several execution sessions and ownership` | 44-SES-036 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; named SQLite generic reader only; existing generic callers remain on JSON |
| 44-SES-039 | With several live interrupts and no main, the generic reader reports ambiguity and requires an explicit session ID. | 44-FCR, `Several execution sessions and ownership` | 44-SES-036 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; named SQLite generic reader only; existing generic callers remain on JSON |
| 44-SES-040 | The generic reader never chooses a session heuristically. | 44-FCR, `Several execution sessions and ownership` | 44-SES-036 through 44-SES-039 | S2 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; named SQLite generic reader only; existing generic callers remain on JSON |
| 44-SES-041 | Monitoring and multi-session APIs list exact sessions. | 44-FCR, `Several execution sessions and ownership` | 44-SES-030 | S6 | [private storage foundation](stage-session-foundation.md#boundary) | [focused and broader checks](stage-session-foundation.md#verification) | [safety](session-storage-safety-review.md), [compatibility](session-foundation-compatibility-review.md) | partial; exact SQLite listing API only; monitoring integration remains pending |
...
| 44-SES-047 | `recover --dry-run` previews the same complete stale-session set without mutation. | 44-FCR, `Several execution sessions and ownership` | 44-SES-045, 44-CMD-039 | S5 | pending | pending | pending | live SQLite preview acceptance blocked by [AQ1](architectural-questions.md#aq1-sqlite-coordination-during-read-only-previews); independent work pending |
...
| 44-MIS-021 | A misalignment conflict is distinct from an instability conflict. | 44-FCR, `Misalignment` | 44-MIS-020, 44-CMP-005 | S3 | pending | pending | pending | pending |
| 44-MIS-022 | Preflight blocks `resume`, `resumefrom`, and `resumebetween`, including their interrupt forms, before mutation when the selection has a misalignment conflict. | 44-FCR, `Misalignment` | 44-MIS-020, 44-CMD-001 | S3, S4 | pending | pending | pending | pending |
| 44-MIS-023 | A full component run or reset can repair alignment. | 44-FCR, `Misalignment` | 44-CMD-011 | S3 | pending | pending | pending | pending |
...
| 44-MEM-002 | Associate persisted component state with the graph shape that produced it. | 44-FCR, `Component membership changes` | 44-MEM-001, 44-CMP-025 | S2 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-003 | If membership changes while reusable history exists, execution touching the affected area refuses until fresh preparation resolves the ambiguity. | 44-FCR, `Component membership changes` | 44-MEM-002 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-004 | A targeted reset is sufficient to repair a membership change. | 44-FCR, `Component membership changes` | 44-MEM-003 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-005 | Expand membership repair through the transitive overlap of stored and current component memberships. | 44-FCR, `Component membership changes` | 44-MEM-004 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-006 | If stored `{A, B}` becomes current `{A}` and `{B}`, `mwf reset A` also prepares `{B}`. | 44-FCR, `Component membership changes` | 44-MEM-005 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-007 | If stored `{A}` and `{B}` becomes current `{A, B}`, resetting A prepares the new combined component. | 44-FCR, `Component membership changes` | 44-MEM-005 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-008 | Show expanded repair scope before applying it. | 44-FCR, `Component membership changes` | 44-MEM-005 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-009 | Membership repair does not reset unrelated components. | 44-FCR, `Component membership changes` | 44-MEM-005 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
| 44-MEM-010 | If no reusable work exists, reconcile membership records automatically. | 44-FCR, `Component membership changes` | 44-MEM-002 | S3 | pending | pending | pending | general migration and graph-update integration blocked by [AQ3](architectural-questions.md#aq3-authoritative-component-membership-before-migration); independent work pending |
...
| 44-REC-013 | Recheck available Parent Repo repositories for external executable callers of the four removed commands before implementation. | 44-FCR, `Required reconciliation with current MWF` | 44-CMD-025 | S4 | [retirement](stage-retirement.md) | [checks passed](stage-retirement.md#test-first-and-preservation-checks) | [Sol xhigh PASS](retirement-review.md) | verified for retirement; later-stage preservation remains required |
| 44-REC-014 | Exercise real scheduler, storage, parser, monitoring, input, and trace paths. | 44-FCR, `Required reconciliation with current MWF` | all runtime requirements | ALL | partial: [retained scheduler repair](stage-scheduler-completion.md) | real scheduler and SQLite RED/GREEN, cyclic and combined checks in the stage record | [safety](scheduler-safety-review.md) and [compatibility](scheduler-compatibility-review.md) passed for this section | partial; remaining runtime requirements pending |
...
| 44-REC-021 | Regression coverage includes component state and membership changes. | 44-FCR, `Required reconciliation with current MWF` | 44-CMP-001 through 44-CMP-026, 44-MEM-001 through 44-MEM-010 | S2, S3, S4, S6 | pending | pending | pending | pending |
...
| 44-REC-023 | Regression coverage includes sample parsing, status filtering, and percentage rounding. | 44-FCR, `Required reconciliation with current MWF` | 44-SMP-003 through 44-SMP-013, 44-SMP-015 through 44-SMP-019 | S4 | pending | pending | pending | pending |
...
| 44-REC-030 | Regression coverage includes fences, stable and unstable propagation, conflicts, and explicit origin replacement. | 44-FCR, `Required reconciliation with current MWF` | 44-INT-021 through 44-INT-039, 44-INT-041 | S5 | pending | pending | pending | pending |
...
| 44-REC-035 | Regression coverage includes mutating crash recovery and stale-hold release. | 44-FCR, `Required reconciliation with current MWF` | 44-INT-048 through 44-INT-050, 44-INT-052, 44-SES-045 through 44-SES-048 | S5 | pending | pending | pending | pending |
...
| 44-REC-043 | Regression coverage completes preview behavior for excluded downstream mutations, affected receivers, and required guards after S3 establishes ownership data. | 44-FCR, `Producer-qualified input and fresh preparation` and `Required reconciliation with current MWF` | 44-CMD-037, 44-PRP-036 through 44-PRP-044, 44-PRP-046 | S3 | pending | pending | pending | pending |
| 44-REC-044 | Regression coverage includes read-only reporting of stale sessions and the recovery that would occur. | 44-FCR, `Explicit interruption` and `Required reconciliation with current MWF` | 44-INT-051, 44-CMD-039 | S6 | pending | pending | pending | live SQLite preview acceptance blocked by [AQ1](architectural-questions.md#aq1-sqlite-coordination-during-read-only-previews); independent work pending |
...
| 45-PLN-010 | Assess selection calculations and the read-only preview base as the first dependency group. | 45-PROC, `1. Establish requirements and stages` | 44-CMD-014, 44-CMD-016 through 44-CMD-022, 44-CMD-031 through 44-CMD-036, 44-CMD-038 through 44-CMD-046 | S1 | pending | pending | pending | pending |
| 45-PLN-011 | Assess component identity and lifecycle, durable sessions, ownership, migration, and recovery foundations as the second dependency group. | 45-PROC, `1. Establish requirements and stages` | 44-CMP-001 through 44-CMP-010, 44-CMP-015 through 44-CMP-019, 44-CMP-022, 44-CMP-025, 44-CMP-026, 44-SES-001 through 44-SES-004, 44-SES-006, 44-SES-012, 44-SES-027, 44-SES-028, 44-SES-030 through 44-SES-040, 44-INT-048 | S2 | pending | pending | pending | pending |
...
| 45-REV-011 | Preserve existing behavior except where an approved requirement changes it. | 45-PROC, `3. Review each stage according to its impact` | 45-PLN-006 | ALL | partial: [retained scheduler repair](stage-scheduler-completion.md) | ordinary, cyclic, stress, benchmark and combined checks in the stage record | [safety](scheduler-safety-review.md) and [compatibility](scheduler-compatibility-review.md) passed for this section | partial; later sections pending |
...
| 45-REV-017 | Use blast-radius guidance to inspect effects elsewhere. | 45-PROC, `3. Review each stage according to its impact` | 45-REV-010 | ALL | partial: [retained scheduler repair](stage-scheduler-completion.md) | real publication, finite-pump admission, resident deadlock and cleanup checks | [safety](scheduler-safety-review.md) and [compatibility](scheduler-compatibility-review.md) passed for this section | partial; later sections pending |
